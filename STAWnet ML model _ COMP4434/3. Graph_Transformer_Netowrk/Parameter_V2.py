...
class GraphTransformerNetwork(nn.Module):
    def __init__(self, num_nodes, seq_len, input_dim, hidden_dim, num_heads, num_layers, output_dim):
        ...
        encoder_layers = TransformerEncoderLayer(d_model=hidden_dim, nhead=num_heads, dropout=0.1, batch_first=True)
...
num_layers = 4   # Increased number of Transformer layers
output_dim = 1
